...
\begin{upeshell}
$ ^\upein{mail nico}^
^\upeexp{Now type in the text of the letter}^
^\upeexp{on as many line as you like ...}^
^\upeexp{After the last line of the letter}^
^\upeexp{type a control-d}^
^\textit{\textrm{ctl}}\upein{-d}^
$
\end{upeshell}
